...
class Listaconcatenata:
    ...
    def trova_rango(self,valore):  # questa funzione non ordina ma cerca solamente il rango, potrebbe essere utile guardarla anche nel caso la lista sia ordinata
        if not self.testa:
            return None  # Lista vuota
